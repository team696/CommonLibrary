...
public class SwerveConstants {
		...
		public static final Distance DRIVEBASE_RADIUS_M = Inches.of(Math.sqrt(Math.pow(WHEELBASE_X.in(Inches), 2) + Math.pow(WHEELBASE_Y.in(Inches), 2)));
		...
		public static final AngularVelocity THEORETICAL_MAX_ANGULAR_VELOCITY = RotationsPerSecond.of(THEORETICAL_MAX_SPEED.in(MetersPerSecond) / (DRIVEBASE_RADIUS_M.in(Meters) * 2 * Math.PI));
